...
- Aligned with a position argument: $\begin{aligned}[t] a &= b \end{aligned}$ <!-- expect: a = b -->
- OCR array of equations: $\begin{array}{l} u_{t} + u u_{x} = 0 \\ u(0, x) = -\sin(\pi x) \end{array}$ <!-- expect: uₜ + u uₓ = 0; u(0, x) = -sin(πx) -->
